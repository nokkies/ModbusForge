...
namespace ModbusForge.Services
{
    ...
    {
        Task<DeviceIdentificationResult?> ReadAsync(
            string ipAddress,
            int port,
            byte unitId,
    ...
    public class DeviceIdentificationReader : IDeviceIdentificationReader
    {
        ...
        public async Task<DeviceIdentificationResult?> ReadAsync(
            string ipAddress,
            int port,
            byte unitId,
            int connectTimeoutMs,
        ...
        /// </summary>
        internal static DeviceIdentificationResult? Parse(byte[] pdu)
        {
