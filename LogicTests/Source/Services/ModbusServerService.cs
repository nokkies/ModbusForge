...
namespace ModbusForge.Services
{
    public class ModbusServerService : IModbusService, IDisposable
    {
        ...
        private void CleanupResources()
        {
            ...
            {
                _logger.LogWarning(ex, "Failed to stop Modbus multi-server during cleanup.");
            }
            ...
            {
                _logger.LogWarning(ex, "Failed to dispose Modbus multi-server during cleanup.");
            }
            _multiServer = null;
        }
        ...
        private string GetLocalNetworkIp()
        {
            ...
            {
                _logger.LogWarning(ex, "Failed to resolve local network IP address.");
            }
            return "0.0.0.0";
        }
